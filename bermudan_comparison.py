"""
Bermudan payer swaption: European (Jamshidian) vs LSMC.

Contract:
    10Y semi-annual payer IRS, K = par rate, N = R1,000,000
    Flat curve: P(0,T) = exp(-0.05 T)
    Hull-White: a = 0.10, sigma = 0.05
    European  : single exercise at T0 = 1 (Jamshidian, closed-form)
    Bermudan  : annual exercise at T = 1, 2, ..., 9

References:
    Jamshidian (1989) J. Finance 44(1): 205-209
    Longstaff & Schwartz (2001) Rev. Fin. Studies 14(1): 113-147
"""
